...
```python
from sim_utils.harness.reporting import build_optimization_summary, save_summary
...
- [ ] extra selection is correct:
  - `sim-utils[harness]` for sweep-only flows
  - `sim-utils[harness,ml]` for optimization flows
