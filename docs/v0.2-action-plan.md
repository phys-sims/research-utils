...
### Sprint 1
- [ ] ADR determinism policy merged
- [ ] ADR composition semantics merged
- [ ] STATUS/roadmap sync completed

### Sprint 2
- [ ] Constraint model + unit tests merged
- [ ] Penalty/feasibility integration path merged

### Sprint 3
- [ ] Determinism integration tests for constraints merged
- [ ] Composition interfaces and staged baseline merged

### Sprint 4
- [ ] Portfolio baseline + composition integration tests merged
- [ ] Agent experiment generation v1 merged

### Sprint 5
- [ ] Validation agent checks v1 merged
- [ ] Canonical reporting artifact/schema + docs merged

### Sprint 6
- [ ] Release readiness checklist complete
- [ ] Version + release notes + final STATUS sync merged
