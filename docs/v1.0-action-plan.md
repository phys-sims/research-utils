...
This action plan converts the v1.0 roadmap into execution-ready work packages,
with sequencing, explicit outputs, and exit criteria.

## Scope

v1.0 roadmap commitments from `STATUS.md`:
- CMA-ES (optional)
...
**Goal**
Lock the decisions needed to execute v1.0 without contract drift.
...
**Exit criteria**
- ADR checklist in `STATUS.md` has no unresolved v1.0 design blockers.
- `STATUS.md`, ADRs, and docs refer to the same v1.0 scope.
...
**Goal**
Make v1.0 outputs easier to analyze, compare, and audit.
...
**Goal**
Release v1.0 with synchronized code, tests, docs, and roadmap state.
...
- `STATUS.md` accurately reflects shipped v1.0 scope.
...
All six planned v1.0 sprints are complete as of 2026-02-12, with roadmap items reflected in `STATUS.md` and release notes published in `docs/releases/v1.0.0.md`.
